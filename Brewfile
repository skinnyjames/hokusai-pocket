...
spec("hokusai-pocket") do |config|
  ...
  task "libuv" do
    ...
    def build
      command("mkdir -p vendor/libuv/build")
      command("cmake -DCMAKE_BUILD_TYPE=Debug ..", chdir: "vendor/libuv/build")
      command("cmake --build ../build", chdir: "vendor/libuv/build")
    end
  end
  ...
  task "hokusai-github" do |args|
    ...
    dependency "libuv" do
      files "vendor/libuv/build/libuv.a"
    end
  ...
  task "hokusai" do |args|
    ...
    def build
      ...
      command("${CC:-gcc} -O3 -Wall -I../../vendor/mruby/include -I../../vendor/hokusai-pocket -I../../src -c ../../src/mruby-uv/loop.c", chdir: "vendor/hokusai-pocket")
  ...
  task "cli" do |args|
    ...
    def build
      ...
      command("#{config.cc.gcc} -O2 -Wall -g -fsanitize=undefined -fsanitize=address #{includes.join(" ")} -o bin/hokusai-pocket vendor/cli/hokusai-pocket.c -L. #{links.join(" ")} #{frameworks(args)}")
    end
  end
